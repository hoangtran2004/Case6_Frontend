                                                ...
                                                <div className="col-5 card-job">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-7" style={{marginLeft: "15px"}}>
                                                            ...
                                                            <p className="companyName">{item?.addressWork}</p>
                                                        </div>
                                                        <div className="col-3">
                                                    ...
                                                    <div className="row" style={{marginTop:'-20px'}}>
                                                        <div className="col-12">
                                                            <div className="card-description">
                                                                ...
                                                                <div className="description"><img
                                                                    src="https://cdn-icons-png.flaticon.com/128/3885/3885079.png" alt=""
                                                                    className="icon-description"/>Số lượng ứng tuyển : {item?.applicants}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
