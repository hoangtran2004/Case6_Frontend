                            ...
                            <div className="col-5 card-job">
                                <div className="row">
                                    ...
                                    <div className="col-7" style={{marginLeft: "15px"}}>
                                        <p className="job-description">Nhân viên tiếp tân khách sạn </p>
                                        <p className="companyName">Công ty TNHH 1 thành viên</p>
                                    </div>
                                    <div className="col-3">
                                    ...
                                    <div className="col-12">
                                        <div className="card-description">
                                            <div className="description"><img
                                                ...
                                                className="icon-description"/>Hà Nội
                                            </div>
                                            <div className="description"><img
                                                src="https://cdn-icons-png.flaticon.com/128/2454/2454282.png" alt=""
                                                className="icon-description"/>VND 20.000.000 - 50.000.000
                                            </div>
                                            <div className="description"><img
                                                src="https://cdn-icons-png.flaticon.com/128/639/639394.png" alt=""
                                                className="icon-description"/>Từ 3-5 năm
                                            </div>
                                        </div>
                                    </div>
                                </div>
